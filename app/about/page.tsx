        ...
        <div className="flex flex-col md:flex-row h-full pt-5 pb-5 justify-between items-center">
          <div className="md:w-1/2 w-full p-5 flex flex-col justify-start">
            ...
            <h3 className="text-white">
              ...
              it's building a mobile app, crafting beautiful UIs, or designing
              robust backend systems.
              <br />
              <br /> Over the years, I’ve built several projects using React,
              Next.js, React Native, TypeScript, Node.js, PostgreSQL, and more.
              I’m currently diving deeper into building developer tools, UI
              libraries, and <span className="text-cyan-300">
                Micro-SaaS
              </span>{" "}
              products.
              <br />
