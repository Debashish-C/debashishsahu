...
export default function Home() {
  return (
    <div className="flex flex-col justify-center items-center  dark:bg-[#0D0D0D]/70 min-h-screen bg-gradient- bg-white from-[#f7f9fc] via-[#e9f2ff] to-[#dff6ff] text-gray-900 dark:from-[#0f172a] dark:via-[#1e293b] dark:to-[#020617] dark:text-gray-100 transition-colors duration-700">
      <div className="lg:max-w-5xl pt-32 w-full flex flex-col justify-center items-center px-6 sm:px-12 py-20">
        <div className="flex flex-col-reverse sm:flex-row w-full items-center justify-between gap-10">
          ...
          <motion.div
            ...
            className="flex flex-col w-full  space-y-5 text-center sm:text-left"
          >
